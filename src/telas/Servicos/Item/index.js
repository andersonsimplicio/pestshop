...
export default function Item({nome,preco,descricao}){
    ...
    const atulizaQuantidadeTotal = (novaQuantidade) =>{
                ...
                { expandir && 
                    ...
                    <View>
                        <View  style={estilos.valor}>
                            ...
                            <CampoInteiro estilos={estilos.quantidade} valor={quantidade} acao={atulizaQuantidadeTotal} />
                        </View>
                        <View  style={estilos.valor}>
